...
import 'package:loginsss/screens/homeAdmin/add_screen.dart';
import 'package:loginsss/screens/homeAdmin/days_screen.dart';
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: [
          BottomNavigationBarItem(
              ...
              BottomNavigationBarItem(
              icon: Icon(Icons.lock), title: Text("รายการที่ล็อค")),
              BottomNavigationBarItem(
              icon: Icon(Icons.add_circle_outline), title: Text("เพิ่มที่ล็อค")),
          BottomNavigationBarItem(
              icon: Icon(Icons.note), title: Text("สรุปยอด")),
          BottomNavigationBarItem(
